...
/// StoreKit 2 manager: loads the two Attic Pro subscriptions, handles
/// purchases, keeps the entitlement flag fresh, and gates the free tier
/// (3 lifetime free scans tracked in UserDefaults).
@Observable
final class StoreManager {

    static let monthlyProductID = "attic_pro_monthly"
    static let yearlyProductID = "attic_pro_yearly"
    static let productIDs: Set<String> = [monthlyProductID, yearlyProductID]

    static let freeScanLimit = 3
    private static let freeScansUsedKey = "attic.freeScansUsed"
